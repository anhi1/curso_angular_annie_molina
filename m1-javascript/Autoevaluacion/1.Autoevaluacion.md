...
A. == 
B. +=  (√) se utiliza para sumar el valor de la variable,  variable = variable + valor.
C. &&
D. ||
...
A. push // El método push se utiliza para agregar uno o más elementos al final del array.
B. splice //crea y devuelve un nuevo array que contiene los elementos que cumplen una determinada condición definida en una función de filtrado.
C. filter (√) //crea y devuelve un nuevo array que contiene los elementos que cumplen una determinada condición definida en una función de filtrado.
...
//en JavaScript permite transformar todos los elementos de un array y devuelve un nuevo array con los resultados de dicha transformación. 